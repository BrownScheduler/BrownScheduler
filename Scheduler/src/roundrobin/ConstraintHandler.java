...
public class ConstraintHandler {
	...
	private ArrayList<Referee> _judges;
	...
	public ConstraintHandler(List<Team> teams, List<Referee> referees){
		this._teams = new ArrayList<Team>(teams);
		this._judges = new ArrayList<Referee>(referees);
	}
